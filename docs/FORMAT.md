...
| --- | --- | --- |
| a footnote storage with a kind, a stylesheet and a string | 3001 of 3001 storages carry `table_para_style`, `table_para_data`, `table_list_style`, `in_document`, `table_para_starts`, `table_para_bidi` | no paragraph style — the omission that rendered a body unstyled once already |
...
fixtures here, 3001 storages carry the field and **zero** declare it. What
...
| --- | --- | ---: | ---: |
| `TSWP.StorageArchive` | `style_sheet` | 3001 | **0** |
