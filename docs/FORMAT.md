...
| --- | --- | --- |
| a footnote storage with a kind, a stylesheet and a string | 2958 of 2958 storages carry `table_para_style`, `table_para_data`, `table_list_style`, `in_document`, `table_para_starts`, `table_para_bidi` | no paragraph style — the omission that rendered a body unstyled once already |
...
fixtures here, 2958 storages carry the field and **zero** declare it. What
...
| --- | --- | ---: | ---: |
| `TSWP.StorageArchive` | `style_sheet` | 2958 | **0** |
